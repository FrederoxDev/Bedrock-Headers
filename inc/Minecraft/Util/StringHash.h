...
class HashedString {
 ...
 public:
  ...
  HashedString(const std::string& str)
      : mStr(str), mStrHash(computeHash(str)) {}
  ...
  bool operator==(const HashedString& rhs) const {
    if (mStrHash == rhs.mStrHash) return mStr == rhs.mStr;
    return false;
  }
  bool operator!=(const HashedString& rhs) const {
    if (mStrHash == rhs.mStrHash) return mStr != rhs.mStr;
...
class HashString {
 ...
 public:
  ...
  Util::HashString& operator=(const std::string&);
  Util::HashString& operator=(const Util::HashString&);
  bool operator==(const Util::HashString&) const;
  bool operator!=(const Util::HashString&) const;
  bool operator<(const Util::HashString&) const;
